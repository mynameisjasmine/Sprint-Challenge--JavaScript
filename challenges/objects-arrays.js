...
/* Request 1: .forEach()
The zoo wants to display both the scientific name and the animal name in front of the habitats.  Return an array with 
...
const lowerCase = [];
let lower = zooAnimals.map((name => name.animal_name.toLowerCase()));
